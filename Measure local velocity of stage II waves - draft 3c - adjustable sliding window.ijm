...
for(a=1; a<=nSlices; a++){
		...
		if(startFound && endFound){
			...
			waveFrontStack(waveStart, waveEnd, longestWave, grid, waveCount, waveGap, step);
...
function waveFrontStack(startSlice, endSlice, stackLength, grid, waveCount, waveGap, step){
